...
program computer_time
    ...
    integer(8), dimension(:), allocatable           :: arr_int, mat_int
   ...
   !integers
    ...
    write(*, '(a100, i10, 1f12.6)') "Single value, integer assignment. {reps, time}:",&
    reps, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (single precision) assignment. {reps, time}:",&
    reps, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (double precision) assignment. {reps, time}:",&
    reps, time   
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, 1f12.6)') "Single value, integer readout and assignment. {reps, time}:", &
    reps, time    
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (single precision) readout and assignment. {reps, time}:", &
    reps, time    
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (double precision) readout and assignment. {reps, time}:", &
    reps, time     
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, integer addition. {reps, time}:", reps, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (single precision) addition. {reps, time}:", reps, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (double precision) addition. {reps, time}:", reps, time   
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, integer multiplication. {reps, time}:", reps, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (single precision) multiplication. {reps, time}:", reps, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps) * 1e9
    write(*, '(a100, i10, f12.6)') "Single value, float (double precision) multiplication. {reps, time}:", reps, time       
    ...
    write(*, '(a100, i10, i10, f12.6)'), "1D array assignment. {reps, dim, time}:", reps, n, time
    ...
    call cpu_time(t2)
    time = time_reps(t1,t2,reps)/real(n) * 1e9
    write(*, '(a100, i10, i10, f12.6)'), "2D array assignment. {reps, dim, time}:", reps, n, time    
    ...
    !cpu time for assigning values in an array
    !assigning integer values in an array
    n=1e5
    allocate(mat_int(n))
    do i=1, reps
        call cpu_time(t1)
    ...
    write(*, '(i6, 2f12.6, a50)') n, t_mean, t_sd, "1d assignment integer"
    ...
    t_mean = sum(times)/real(reps)
    t_sd = sqrt((sum(times-t_mean)**2)/real(reps))
    write(*, '(i6, 2f12.6, a50)') n, t_mean, t_sd, "1d assignment real (single)"
