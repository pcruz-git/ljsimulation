module parameters
    ...
    !Other parameters
    logical, parameter                  :: thermos = .true. !determines if a thermocouple/thermostat will be used
    real(8), parameter                  :: thermos_temp = 94.4_8 !temperature of the heat bath/reservoir
    integer(8), parameter               :: update = 20 !frequency of update
    character(len=*), parameter         :: inputfile = 'argon_lattice.dat'
    integer(8), parameter               :: n_bins = 200 ! bin windows
    integer(8), parameter               :: n_equil = 2000 ! equilibriation steps
